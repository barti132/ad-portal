...
import pl.bartoszsredzinski.application.backend.repository.ContactRepository;
        ...
        if(contactRepository.count() == 0){
            ...
            contactRepository.saveAll(
                    Stream.of("Gabrielle Patel", "Brian Robinson", "Eduardo Haugen", "Koen Johansen", "Alejandro Macdonald",
                            ...
                            "Rene Carlsson", "Elvis Olsen", "Solomon Olsen", "Jaydan Jackson", "Bernard Nilsen").map(name -> {
